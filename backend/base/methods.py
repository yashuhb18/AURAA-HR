...
from auraahra.auraahra_apps import NESTED_SUBORDINATE_VISIBILITY
from auraahra.auraahra_middlewares import _thread_locals
from auraahra.auraahra_settings import auraahra_DATE_FORMATS, auraahra_TIME_FORMATS
...
def format_export_value(value, employee):
    ...
    if isinstance(value, time):
        ...
        for format_name, format_string in auraahra_TIME_FORMATS.items():
