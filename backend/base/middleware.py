...
from auraahra.auraahra_apps import TWO_FACTORS_AUTHENTICATION
from auraahra.auraahra_settings import APPS
from auraahra.methods import get_auraahra_model_class
from auraahra_documents.models import DocumentRequest

CACHE_KEY = "auraahra_company_models_cache_key"
...
class CompanyMiddleware:
    ...
    def _add_company_filter(self, model, company_id):
        ...
        is_auraahra_manager = isinstance(model.objects, auraahraCompanyManager)
        ...
        if is_company_model:
            ...
            elif is_auraahra_manager and related_company_field:
                model.add_to_class(
            ...
            for app_label, models in app_model_mappings.items():
                if apps.is_installed(app_label):
                    company_models.extend(
                        [get_auraahra_model_class(app_label, model) for model in models]
                    )
