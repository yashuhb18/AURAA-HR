...
class AssignPermission(Form):
    ...
    employee = auraahraMultiSelectField(
...
class JobPositionMultiForm(ModelForm):
    ...
    department_id = auraahraMultiSelectField(
...
class RotatingWorkTypeAssignForm(ModelForm):
    ...
    employee_id = auraahraMultiSelectField(
...
class AnnouncementForm(ModelForm):
    ...
    employees = auraahraMultiSelectField(
        queryset=Employee.objects.all(),
        widget=auraahraMultiSelectWidget(
            filter_route_name="employee-widget-filter",
            filter_class=EmployeeFilter,
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employees"], auraahraMultiSelectField):
...
class PenaltyAccountForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave") and employee:
            LeaveType = get_auraahra_model_class(app_label="leave", model="leavetype")
