...
from base import announcement, request_and_approve, views, auraahra_views
...
urlpatterns = [
    path("aurahr-home/", views.home, name="home-page"),
    path(
        "".join(("hori", "lla-home/")),
    ...
    path(
        "forgot-password",
        views.auraahraPasswordResetView.as_view(),
    ...
    path(
        "get-auraahra-installed-apps/",
        views.get_auraahra_installed_apps,
        name="get-auraahra-installed-apps",
    ),
