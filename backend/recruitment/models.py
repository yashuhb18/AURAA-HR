...
from auraahra_audit.methods import get_diff
from auraahra_audit.models import auraahraAuditInfo, auraahraAuditLog
from auraahra_views.cbv_methods import render_template
...
class SurveyTemplate(auraahraModel):
    """
    ...
    objects = auraahraCompanyManager("company_id")
...
class Recruitment(auraahraModel):
    """
    Recruitment model
    """
...
class Stage(auraahraModel):
    ...
    objects = auraahraCompanyManager(related_company_field="recruitment_id__company_id")
...
class RejectReason(auraahraModel):
    """
    RejectReason
    """
...
class RejectedCandidate(auraahraModel):
    """
    RejectedCandidate
    """
...
class StageFiles(auraahraModel):
...
class RecruitmentSurvey(auraahraModel):
    """
    ...
    objects = auraahraCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(auraahraModel):
    """
...
class RecruitmentSurveyAnswer(auraahraModel):
    """
...
class SkillZoneCandidate(auraahraModel):
    """
...
class CandidateRating(auraahraModel):
...
class RecruitmentGeneralSetting(auraahraModel):
    """
...
class InterviewSchedule(auraahraModel):
    """
    ...
    objects = auraahraCompanyManager("candidate_id__recruitment_id__company_id")
...
class CandidateDocumentRequest(auraahraModel):
    title = models.CharField(max_length=100)
...
class CandidateDocument(auraahraModel):
...
class LinkedInAccount(auraahraModel):
