...
class LinkedinSettingSectionView(views.auraahraSectionView):
    """
...
class LinkedInSettingNavView(views.auraahraNavView):
    """
...
class LinkedInAccountFormView(views.auraahraFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.auraahraListView):
    """
