...
from auraahra.auraahra_settings import APP_URLS, DYNAMIC_URL_PATTERNS


def get_auraahra_model_class(app_label, model):
    """
...
def auraahra_users_with_perms(permissions):
    """
