...
This module is used to register auraahra addons
"""

from auraahra import settings
from auraahra.settings import INSTALLED_APPS

INSTALLED_APPS.append("accessibility")
INSTALLED_APPS.append("auraahra_audit")
INSTALLED_APPS.append("auraahra_widgets")
INSTALLED_APPS.append("auraahra_crumbs")
INSTALLED_APPS.append("auraahra_documents")
INSTALLED_APPS.append("auraahra_views")
INSTALLED_APPS.append("auraahra_automations")
INSTALLED_APPS.append("auditlog")
INSTALLED_APPS.append("biometric")
INSTALLED_APPS.append("helpdesk")
INSTALLED_APPS.append("offboarding")
INSTALLED_APPS.append("auraahra_backup")
