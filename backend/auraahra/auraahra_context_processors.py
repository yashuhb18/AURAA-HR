"""
auraahra_context_process.py

This module is used to register context processors without effecting the auraahra/settings.py module
"""

from auraahra.settings import TEMPLATES

TEMPLATES[0]["OPTIONS"]["context_processors"].append(
    "auraahra.config.get_MENUS",
)
TEMPLATES[0]["OPTIONS"]["context_processors"].append(
