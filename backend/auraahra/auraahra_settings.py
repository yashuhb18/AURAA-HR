...
from auraahra.auraahra_apps import INSTALLED_APPS
...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": settings.env("BIND_DN", default="cn=admin,dc=auraahra,dc=com"),
    "BIND_PASSWORD": settings.env("BIND_PASSWORD", default="auraahra"),
    "BASE_DN": settings.env("BASE_DN", default="ou=users,dc=auraahra,dc=com"),
}
...
def load_ldap_settings():
    ...
    try:
        ...
        from auraahra_ldap.models import LDAPSettings
