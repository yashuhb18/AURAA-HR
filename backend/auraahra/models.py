...
This module defines the abstract base model `auraahraModel` for the auraahra HRMS project.
The `auraahraModel` provides common fields and functionalities for other models within
...
class auraahraModel(models.Model):
    """
    An abstract base model that includes common fields and functionalities
    for models within the auraahra application.
    """
    ...
    auraahra_history = AuditlogHistoryField()
    ...
    def save(self, *args, **kwargs):
        ...
        super(auraahraModel, self).save(*args, **kwargs)
...
auditlog.register(auraahraModel, serialize_data=True)
