"""
Django settings for auraahra project.
...
MIDDLEWARE = [
    ...
    "auraahra_api.middleware.RejectBasicAuthMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "base.auraahra_context.auraahra_branding",
            ],
        },
    },
]

WSGI_APPLICATION = "auraahra.wsgi.application"
...
# auraahra Branding Configuration
AURAAHRA_BRANDING = {
    "APP_NAME": "AuraHR",
