...
from base.forms import ModelForm as auraahraModelForm
...
from auraahra_widgets.widgets.select_widgets import auraahraMultiSelectWidget
...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = auraahraMultiSelectField(
            queryset=Employee.objects.all(),
            widget=auraahraMultiSelectWidget(
        ...
        self.fields["managers"] = auraahraMultiSelectField(
            queryset=Employee.objects.all(),
            widget=auraahraMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class KRForm(auraahraModelForm):
    """
...
class FeedbackForm(auraahraModelForm):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # # auraahra multi-select filter for subordinates
        # self.fields["subordinate_id"] = auraahraMultiSelectField(
        #     queryset=Employee.objects.all(),
        #     widget=auraahraMultiSelectWidget(
        #         filter_route_name="employee-widget-filter",
        #         filter_class=EmployeeFilter,
...
class PeriodForm(auraahraModelForm):
    """
...
class MeetingsForm(BaseForm):
    ...
    def as_p(self):
        ...
        """
        context = {"form": self}
        table_html = render_to_string("auraahra_form.html", context)
        return table_html
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employee_id"], auraahraMultiSelectField):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_id"] = auraahraMultiSelectField(
...
class BonusPointSettingForm(auraahraModelForm):
    """
...
class EmployeeBonusPointForm(auraahraModelForm):
    """
...
class EmployeeFeedbackForm(auraahraModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["others_id"] = auraahraMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=auraahraMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["others_id"], auraahraMultiSelectField):
...
class BulkFeedbackForm(auraahraModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_ids"] = auraahraMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=auraahraMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["employee_ids"], auraahraMultiSelectField):
