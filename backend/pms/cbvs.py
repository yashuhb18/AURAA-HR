...
from auraahra.decorators import login_required, owner_can_enter, permission_required
...
class BonusPointSettingSectionView(views.auraahraSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.auraahraNavView):
    """
...
class BonusPointSettingFormView(views.auraahraFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.auraahraListView):
    """
...
class EmployeeBonusPointSectionView(views.auraahraSectionView):
    """
...
class EmployeeBonusPointNavView(views.auraahraNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.auraahraFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.auraahraListView):
    """
    BnusPoint list view
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbackEmployeeFormView(views.auraahraFormView):
    """
...
class BulkFeedbackFormView(views.auraahraFormView):
    """
    Feedback other employee form View
    """
