...
from auraahra.models import auraahraModel, has_xss, upload_path
...
class Employee(models.Model):
    ...
    def get_archive_condition(self):
        ...
        if apps.is_installed("onboarding"):
            OnboardingStage = get_auraahra_model_class("onboarding", "onboardingstage")
            OnboardingTask = get_auraahra_model_class("onboarding", "onboardingtask")
        ...
        if apps.is_installed("recruitment"):
            Recruitment = get_auraahra_model_class("recruitment", "recruitment")
            Stage = get_auraahra_model_class("recruitment", "stage")
    ...
    def check_online(self):
        ...
        """
        if apps.is_installed("attendance"):
            Attendance = get_auraahra_model_class("attendance", "attendance")
...
class EmployeeTag(auraahraModel):
    """
    EmployeeTag Model
    """
...
class EmployeeBankDetails(auraahraModel):
    """
...
class EmployeeNote(auraahraModel):
    """
    EmployeeNote model
    """
...
class PolicyMultipleFile(auraahraModel):
    """
...
class BonusPoint(auraahraModel):
    """
...
class Actiontype(auraahraModel):
    """
    Action type model
    """
...
class DisciplinaryAction(auraahraModel):
    """
    Disciplinary model
    """
...
class EmployeeGeneralSetting(auraahraModel):
    """
...
class ProfileEditFeature(auraahraModel):
    """
    ProfileEditFeature
    """
