...
class TimeSheetNavView(auraahraNavView):
    """
    Nav bar
    """
...
class TimeSheetList(auraahraListView):
    """
...
class TimeSheetFormView(auraahraFormView):
    """
...
class TimeSheetCardView(auraahraCardView):
    """
    For card view
    """
...
class TimeSheetDetailView(auraahraDetailedView):
    """
