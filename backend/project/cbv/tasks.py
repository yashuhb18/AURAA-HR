...
from auraahra.methods import handle_no_permission
from auraahra_views.cbv_methods import login_required
from auraahra_views.generic.cbv.views import (
    auraahraCardView,
    auraahraDetailedView,
    auraahraFormView,
    auraahraListView,
    auraahraNavView,
    TemplateView,
...
@method_decorator(login_required, name="dispatch")
class TaskListView(auraahraListView):
    """
...
@method_decorator(login_required, name="dispatch")
class TasksNavBar(auraahraNavView):
    """
    navbar of teh page
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCreateForm(auraahraFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskDetailView(auraahraDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCardView(auraahraCardView):
    """
...
class TasksInIndividualView(TaskListView):
    ...
    def get_queryset(self):
        queryset = auraahraListView.get_queryset(self)
        employee_id = self.request.GET.get("employee_id")
        project_id = self.request.GET.get("project_id")
