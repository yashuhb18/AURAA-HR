...
class ProjectStageCreateForm(auraahraFormView):
    """
    ...
    def get(self, request, *args, pk=None, **kwargs):
        ...
        if project_id:
            try:
                ...
                logger.error(e)
                return auraahraRedirect(request, message=_("Something went wrong!"))
        else:
            return super().get(request, *args, pk=pk, **kwargs)
...
class StageDynamicCreateForm(ProjectStageCreateForm):
    ...
    template_name = auraahraFormView.template_name
