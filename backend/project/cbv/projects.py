...
from auraahra_views.cbv_methods import login_required, permission_required
...
class ProjectsNavView(auraahraNavView):
    """
    Nav bar
    """
...
class ProjectsList(auraahraListView):
    """
    Projects list view
    """
...
class ProjectFormView(auraahraFormView):
    """
...
class ProjectCardView(auraahraCardView):
    """
    For card view
    """
...
# Remove the command lines after auraahra converted into CBV
