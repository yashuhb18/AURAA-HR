...
from auraahra_views.generic.cbv.views import auraahraDetailedView, auraahraListView
...
class ProjectsDueInMonth(auraahraListView):
...
class ProjectDetailView(auraahraDetailedView):
    """
