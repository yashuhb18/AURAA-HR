...
class ProjectStage(auraahraModel):
    """
    ProjectStage model
    """
    ...
    objects = auraahraCompanyManager("project__company_id")
...
class TimeSheet(auraahraModel):
    ...
    objects = auraahraCompanyManager("project_id__company_id")
