...
from auraahra.signals import post_generic_delete, pre_generic_delete
from auraahra_views import models
from auraahra_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from auraahra_views.forms import SavedFilterForm
from auraahra_views.generic.cbv.views import auraahraFormView, auraahraListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.auraahraModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(auraahraFormView):
    """
    SavedFilter
    """
...
class DynamiListView(auraahraListView):
    """
...
class auraahraDeleteConfirmationView(View):
    """
