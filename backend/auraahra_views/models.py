...
class ToggleColumn(auraahraModel):
    """
    ToggleColumn
    """
...
class ActiveGroup(auraahraModel):
    """
    ActiveGroup
    """
...
class SavedFilter(auraahraModel):
    """
    SavedFilter
    """
...
class ActiveView(auraahraModel):
    """
