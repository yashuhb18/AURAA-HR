"""
auraahra_views/urls.py
"""

from django.urls import path

from auraahra_views import views
from auraahra_views.generic.cbv import history
from auraahra_views.generic.cbv.views import ReloadMessages
...
urlpatterns = [
    ...
    path(
        "generic-delete",
        views.auraahraDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "auraahra-history-revert/<int:pk>/<int:history_id>/",
        history.auraahraHistoryView.as_view(),
        name="history-revert",
    ),
]
