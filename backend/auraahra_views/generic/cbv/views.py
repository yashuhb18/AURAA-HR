...
from auraahra.filters import FilterSet
from auraahra.group_by import group_by_queryset
from auraahra.auraahra_middlewares import _thread_locals
from auraahra.http.response import auraahraRedirect
from auraahra.signals import post_generic_import, pre_generic_import
from auraahra_views import models
from auraahra_views.cbv_methods import (  # update_initial_cache,
    assign_related,
    export_xlsx,
...
from auraahra_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
from auraahra_views.templatetags.generic_template_filters import getattribute

logger = logging.getLogger(__name__)


@method_decorator(hx_request_required, name="dispatch")
class auraahraListView(ListView):
    """
    auraahraListView
    """
    ...
    template_name: str = "generic/auraahra_list_table.html"
    ...
    def serve_import_sheet(self, request, *args, **kwargs):
        ...
        if not self.import_accessibility():
            ...
            return auraahraFormView.HttpResponse()
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[auraahraListView] = context
        from auraahra.urls import path, urlpatterns
    ...
    def export_data(self, *args, **kwargs):
        ...
        class auraahraListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = auraahraListViewResorce()
...
class auraahraSectionView(TemplateView):
    """
    auraahra Template View
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, auraahraListView)
    ...
    template_name = "generic/auraahra_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class auraahraDetailedView(DetailView):
    """
    HorillDetailedView
    """

    title = "Detailed View"
    template_name = "generic/auraahra_detailed_view.html"
    header: dict = {
        "title": "auraahra",
        "subtitle": "auraahra Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, auraahraDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class auraahraTabView(TemplateView):
    """
    auraahraTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/auraahra_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.query_params = {}
        # update_initial_cache(request, CACHE, auraahraTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[auraahraTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class auraahraCardView(ListView):
    """
    auraahraCardView
    """
    ...
    template_name = "generic/auraahra_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, auraahraCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[auraahraCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
@method_decorator(hx_request_required, name="dispatch")
class auraahraFormView(FormView):
    """
    auraahraFormView
    """
    ...
    template_name = "generic/auraahra_form.html"
    ids_key: str = "instance_ids"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # update_initial_cache(request, CACHE, auraahraFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not hasattr(self, "form"):
            ...
            if self.request.method == "GET":
                ...
                for dynamic_tuple in self.dynamic_create_fields:
                    ...
                    form.fields[field].widget.option_template_name = (
                        "auraahra_widgets/select_option.html",
                    )
            ...
            # CACHE.get(self.request.session.session_key + "cbv")[auraahraFormView] = form
            self.form = form
        return self.form
...
@method_decorator(hx_request_required, name="dispatch")
class auraahraNavView(TemplateView):
    """
    auraahraNavView
    ...
    template_name = "generic/auraahra_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, auraahraNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[auraahraNavView] = context
        return context
...
@method_decorator(hx_request_required, name="dispatch")
class auraahraProfileView(DetailView):
    """
    GenericauraahraProfileView
    """

    template_name = "generic/auraahra_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.ordered_ids_key = f"ordered_ids_{self.model.__name__.lower()}"
        # update_initial_cache(request, CACHE, auraahraProfileView)
