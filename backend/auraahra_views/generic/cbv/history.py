"""
auraahra_views/generic/cbv/history.py
"""
...
from auraahra_views.cbv_methods import hx_request_required
from auraahra_views.generic.cbv.views import auraahraFormView
from auraahra_views.history_methods import get_diff


@method_decorator(hx_request_required, name="dispatch")
class auraahraHistoryView(DetailView):
    """
    GenericauraahraProfileView
    """

    template_name = "generic/auraahra_history_view.html"
