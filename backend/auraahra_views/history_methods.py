...
from auraahra.decorators import apply_decorators
...
class Bot:
    ...
    def get_avatar(self):
        ...
        Get avatar
        """
        return "https://ui-avatars.com/api/?name=auraahra+Bot&background=random"
...
def history_tracking(request, obj_id, **kwargs):
    ...
    def _history_tracking(request, obj_id, model):
        ...
        histories = instance.auraahra_history.all()
        ...
        return render(
            request,
            "auraahra_audit/history_tracking.html",
            context,
        )
