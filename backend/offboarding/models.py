...
class Offboarding(auraahraModel):
    """
    Offboarding model
    """
...
class OffboardingStage(auraahraModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(auraahraModel):
    """
...
class OffboardingEmployee(auraahraModel):
    """
...
class ResignationLetter(auraahraModel):
    """
...
class OffboardingTask(auraahraModel):
    """
...
class EmployeeTask(auraahraModel):
    """
    EmployeeTask model
    """
...
class ExitReason(auraahraModel):
    """
    ExitReason model
    """
...
class OffboardingNote(auraahraModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(auraahraModel):
    """
