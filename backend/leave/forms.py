"""
This module provides auraahra ModelForms for creating and managing leave-related data,
...
from auraahra_widgets.forms import auraahraForm, auraahraModelForm
...
class LeaveTypeAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if f := self.fields.get("company_id"):
            from auraahra_widgets.forms import default_select_option_template
...
class LeaveOneAssignForm(auraahraModelForm):
    """
    ...
    Attributes:
        - employee_id: A auraahraMultiSelectField representing the employee to assign leave to.
    """
...
class AssignLeaveForm(auraahraForm):
    """
    Form for Payslip
    """
