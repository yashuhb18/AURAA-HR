...
from auraahra.auraahra_settings import DYNAMIC_URL_PATTERNS, auraahra_DATE_FORMATS
from auraahra.http import auraahraRedirect
from auraahra.methods import remove_dynamic_url
...
def validate_bulk_attendance(request):
    ...
    for obj_id in ids:
        try:
            ...
            # Fixes: https://github.com/auraahra/auraahra-hr/issues/1055
...
def work_record_export(request):
    ...
    format_string = auraahra_DATE_FORMATS.get(date_format)
