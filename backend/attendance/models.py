...
class AttendanceActivity(auraahraModel):
    """
...
class BatchAttendance(auraahraModel):
    """
...
class Attendance(auraahraModel):
    """
    Attendance model
    """
...
class AttendanceRequestFile(auraahraModel):
    file = models.FileField(upload_to=upload_path)


class AttendanceRequestComment(auraahraModel):
    """
...
class AttendanceOverTime(auraahraModel):
    """
...
class AttendanceLateComeEarlyOut(auraahraModel):
    """
...
class AttendanceValidationCondition(auraahraModel):
    """
...
class AttendanceGeneralSetting(auraahraModel):
    """
