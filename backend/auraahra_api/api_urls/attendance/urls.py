"""
auraahra_api/urls/attendance/urls.py
"""

from django.urls import path

from auraahra_api.api_views.attendance.permission_views import AttendancePermissionCheck
from auraahra_api.api_views.attendance.views import *
