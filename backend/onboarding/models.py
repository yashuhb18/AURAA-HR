...
class OnboardingStage(auraahraModel):
    """
    ...
    objects = auraahraCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(auraahraModel):
    """
    ...
    objects = auraahraCompanyManager("stage_id__recruitment_id__company_id")
...
class CandidateStage(auraahraModel):
    """
...
class CandidateTask(auraahraModel):
    """
    CandidateTask model
    """
...
class OnboardingPortal(auraahraModel):
    """
