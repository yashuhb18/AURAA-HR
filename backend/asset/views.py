...
from auraahra.methods import auraahra_users_with_perms
...
def asset_allocate_return_request(request, asset_id):
    ...
    permed_users = auraahra_users_with_perms("asset.change_assetassignment")
    notify.send(
        request.user.employee_get,
...
def asset_import(request):
    ...
    Returns:
        auraahraRedirect: A redirect to the asset category view after processing the import.
    """
        ...
        for asset in queryset:
            for field in fields_to_check:
                ...
                if isinstance(value, date):
                    ...
                    for format_name, format_string in auraahra_DATE_FORMATS.items():
