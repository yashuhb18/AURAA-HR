...
class AssetCategory(auraahraModel):
    """
...
class Asset(auraahraModel):
    ...
    objects = auraahraCompanyManager("asset_category_id__company_id")
...
class AssetReport(auraahraModel):
    """
...
class AssetDocuments(auraahraModel):
    """
...
class ReturnImages(auraahraModel):
    """
...
class AssetAssignment(auraahraModel):
    """
    ...
    objects = auraahraCompanyManager("asset_id__asset_lot_number_id__company_id")
...
class AssetRequest(auraahraModel):
    """
