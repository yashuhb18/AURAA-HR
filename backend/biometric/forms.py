...
class DahuaUserForm(Form):
    """
    This form is used to map a auraahra employee to a user entry on a Dahua biometric device.
    """
...
class MapBioUsers(ModelForm):
    """
    Form for mapping biometric users to auraahra employees.

    This form is used to associate a biometric user (from a biometric device) with
    an employee in the auraahra system.
    """
