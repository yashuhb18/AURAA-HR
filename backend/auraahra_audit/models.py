...
from auraahra_audit.methods import remove_duplicate_history
...
class AuditTag(models.Model):
    ...
    class Meta:
        ...
        app_label = "auraahra_audit"


class auraahraAuditInfo(models.Model):
    """
    auraahraAuditInfo model to store additional info
    """
...
class auraahraAuditLog(HistoricalRecords):
    """
    Model to store additional information for historical records.
    """

    # def __init__(self, *args, bases=None, **kwargs):
    #     super(auraahraAuditLog, self).__init__(*args, **kwargs)
    #     self.is_auraahra_audit_log = True
...
def pre_create_auraahra_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_auraahra_audit_log(sender, instance, *_args, **kwargs):
    """
    ...
    try:
        ...
        if isinstance(history_instance, auraahraAuditLog):
