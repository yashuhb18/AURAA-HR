...
This module is used to write auraahra form select widgets
"""
...
class auraahraMultiSelectWidget(forms.Widget):
    """
    auraahraMultiSelectWidget
    """
    ...
    template_name = "auraahra_widgets/auraahra_multiselect_widget.html"
