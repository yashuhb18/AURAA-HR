"""
auraahra_automation/views/views.py
"""
...
from auraahra_automations.methods.methods import generate_choices
from auraahra_automations.methods.serialize import serialize_form
from auraahra_automations.models import MailAutomation
from auraahra_automations.signals import REFRESH_METHODS
from auraahra_views.generic.cbv.views import auraahraFormView
...
@login_required
@permission_required("auraahra_automations.delete_mailautomation")
...
@login_required
@permission_required("auraahra_automations.add_mailautomation")
