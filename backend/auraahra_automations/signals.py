"""
auraahra_automation/signals.py
...
from auraahra.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    from auraahra_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=auraahraMailTemplate)
    @receiver(post_save, sender=auraahraMailTemplate)
...
def send_automated_mail(
    ...
    from auraahra_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from auraahra_automations.methods.methods import (
        get_model_class,
